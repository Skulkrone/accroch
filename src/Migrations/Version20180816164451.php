 ...
 */
final class Version20180816164451 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE announcements CHANGE creation_date creation_date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE announcements CHANGE creation_date creation_date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE cat_announcements ADD fk_announcements_id_id INT NOT NULL');
